...
export const create_team = async (
	...
	const result = await axios({
		...
		url: `/kaggle/groups/${competition_name}`,
		data: {
			name, 
			num_members,
			language,
...
export const leave_team = async (
	...
	const result = await axios({
		...
		url: `/kaggle/${competition_name}/leave`,
	});
	return result;
};
...
export const make_join_request_decision = async (
	...
	const result = await axios({
		...
		url: `/kaggle/groups/join/decision`,
		data: {
			group_pid,
			requester_pid,
			accept,
...
export const sent_invite_request = async (
	...
	const result = await axios({
		...
		url: `/kaggle/groups/invites/${competitionName}`,
		data: {
			invitee_pid,
		},
	});
...
export const make_invite_request_decision = async (
	...
	const result = await axios({
		...
		url: `/kaggle/groups/invites/decision`,
		data: {
			group_pid,
			accept,
		},
